	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
								...
								<div id="detail_table">
									<table class="table border-top mb-0 small fw-light">
										<tr>
											...
											<td class="px-4">
												<input style="width: 200px;" class="form-control rounded-0" name="member_name" type="text"
													size="20" value="${memberInfo.member_name }" disabled />
											</td>
										</tr>
										<tr>
											<td class="table-light ps-4 align-middle" style="width: 200px;">아이디</td>
											<td class="px-4">
												<input style="width: 200px;" name="member_id" class="form-control rounded-0" type="text"
													size="20" value="${memberInfo.member_id }" disabled />
											</td>
										</tr>
										<tr>
											<td class="table-light ps-4 align-middle" style="width: 200px;">비밀번호</td>
											<td class="px-4">
												<input style="width: 200px;" name="member_pw" class="form-control rounded-0" type="password"
													size="20" value="${memberInfo.member_pw }" />
											</td>
										</tr>
										<tr>
											<td class="table-light ps-4 align-middle" style="width: 200px;">휴대폰 번호</td>
											<td class="px-4">
												<input style="width: 200px;" type="text" class="form-control rounded-0" name="hp1" size=4
													value="${memberInfo.hp1 }">
											</td>
										</tr>
										<tr>
											...
											<td class="px-4">
												<div class="input-group mb-2" style="width: 395px;">
													<input type="text" class="form-control rounded-0" placeholder="우편번호"
												...
												<input type="text" id="subaddress" class="form-control rounded-0 mb-2"
													name="subaddress" size="50"
													value="${memberInfo.subaddress }">
											</td>
										</tr>
									</table>
								</div>
		...
		<script>
			...
			function fn_modify_member_info(){
				...
				console.log(member_pw + " "+hp1 + " "+zipcode + " "+member_address + " "+subaddress);
